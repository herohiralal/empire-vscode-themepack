export default ({ name, colors, type }) => ({
  name,
  type: type,
  colors: {
    // Fork changes
    ...
    'editor.background': colors.background5,
    ...
    'editor.rangeHighlightBackground': colors.translucent4,
    'editor.rangeHighlightBorder': colors.translucent4,
